...
func main() {
	...
	chai.Post(r, "/api/v1/examples/post", PostHandler)
	chai.Get(r, "/api/v1/examples/ping", PingHandler)
	chai.Get(r, "/api/v1/examples/calc", CalcHandler)
	chai.Get(r, "/api/v1/examples/groups/{group_id}/accounts/{account_id}", PathParamsHandler)
	chai.Get(r, "/api/v1/examples/header", HeaderHandler)
	chai.Get(r, "/api/v1/examples/securities", SecuritiesHandler)
	chai.Get(r, "/api/v1/examples/attribute", AttributeHandler)
