...
func GetStringByInt(w http.ResponseWriter, r *http.Request) (*string, int, error) {
	s := ""
	return &s, 200, nil
}
...
func GetStructArrayByString(w http.ResponseWriter, r *http.Request) (*string, int, error) {
	s := ""
	return &s, 200, nil
}
